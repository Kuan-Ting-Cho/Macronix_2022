...
int MotorUnion::Leg_id(int id)
{
	...
	int arr[] = {0, 2, 4, 6, 8}; // key in current motor id
...
void MotorUnion::Change_angle(int Angle, int Velocity)
{
	...
	{
	case 49:
		cout << "Open center_angle. " << endl;
		Set_Velocity(Leg_id(8), 1, 1, Velocity);
		Set_Velocity(Leg_id(0), 1, 1, 15);
		Set_Velocity(Leg_id(2), 1, 1, -15);
		Set_Velocity(Leg_id(4), 1, 1, -15);
		Set_Velocity(Leg_id(6), 1, 1, 15);
		break;
	case 50:
		// cout << "Change angle to '" << (Angle - 48) * 10 << "' degrees." << endl;
		cout << "Close center_angle. " << endl;
		Set_Velocity(Leg_id(8), 1, 1, -Velocity);
		Set_Velocity(Leg_id(0), 1, 1, -15);
		Set_Velocity(Leg_id(2), 1, 1, 15);
		Set_Velocity(Leg_id(4), 1, 1, 15);
	...
	case 51:
		...
		Set_Velocity(Leg_id(0), 1, 1, 0);
		Set_Velocity(Leg_id(2), 1, 1, 0);
		Set_Velocity(Leg_id(4), 1, 1, 50);
		Set_Velocity(Leg_id(6), 1, 1, -50);
		break;
	default:
		break;
	}
...
void MotorUnion::Change_cen_angle(int Angle, int Velocity)
{
...
void MotorUnion::TurnRight_withtime(int Velocity, int time)
{
	cout << "Turn right. " << endl;
	Set_Velocity(Leg_id(0), 1, 1, Velocity);
	Set_Velocity(Leg_id(2), 1, 1, Velocity);
...
void MotorUnion::Individual(int Front_vel, int Back_vel)
{
	cout << "Individual. " << endl;
	Set_Velocity(Leg_id(0), 1, 1, -Front_vel);
	Set_Velocity(Leg_id(2), 1, 1, Front_vel);
	Set_Velocity(Leg_id(4), 1, 1, -Back_vel);
	Set_Velocity(Leg_id(6), 1, 1, Back_vel);
}

void MotorUnion::MotorUnion::Sync_Drive(int Velocity, int time)
{
