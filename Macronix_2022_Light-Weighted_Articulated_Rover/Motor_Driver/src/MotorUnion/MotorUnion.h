...
public:
	...
	void Change_cen_angle(int Angle, int Velocity);
	void TurnRight(int Velocity);
	void TurnLeft(int Velocity);
	void TurnRight_withtime(int Velocity, int time);
	void GoStraight(int Velocity);
	void GoBack(int Velocity);
	void Individual(int Front_vel, int Back_vel);
	void Sync_Drive(int Velocity, int time);
};
