...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        test.open("/home/potter/2022WonHon/Motor_Driver/src/test.txt", ios::in | ios::out | ios::app);
        cin >> Command;
        ...
        else if (Command == Function_Key2)
        {
            ...
            test.open("/home/potter/2022WonHon/Motor_Driver/src/test.txt", ios::out | ios::trunc);
        }
        else
        {
            test << Command;
